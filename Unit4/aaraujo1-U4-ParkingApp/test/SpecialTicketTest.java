...
import us.aaraujo1.TicketFactory.SpecialTicket;

import java.time.LocalDateTime;

import static org.junit.Assert.*;

public class SpecialTicketTest extends TestCase {
    SpecialTicket t;

    @Before
    public void setUp() throws Exception {
        t = new SpecialTicket(1, LocalDateTime.parse("2018-12-04T07:49"));
    ...
    public void testGetTicketType() {
        assertEquals("SPECIAL", t.getTicketType().toString());
    }
